...
public class Producto
{
    ...
    private final static double IVA_TIENDA = 0.10;
    ...
    public double aumentarValor() {
        if (valorUnitario < 1) {
            ...
            valorUnitario = valorUnitario * 1.01;

        } else if (valorUnitario<5) {

            valorUnitario = valorUnitario*1.02;

        } else {
            valorUnitario = valorUnitario*1.03;
        }
