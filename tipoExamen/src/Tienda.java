...
public class Tienda
{
    ...
    public Tienda( )
    {
        ...
        producto5 = new Producto( Producto.Tipo.TIENDA, "libreta", 5.5, 44, 15);
        producto6 = new Producto( Producto.Tipo.TIENDA, "leche", 1.9, 25, 10);
        producto7 = new Producto( Producto.Tipo.TIENDA, "jabon", 1.9, 36, 8);
        producto8 = new Producto( Producto.Tipo.TIENDA, "bufanda", 20, 13, 5);
        dineroEnCaja = 0;
    }
    ...
    {
        return "nuevos precios libreta: " + producto5.darValorUnitario() + "leche: " +producto6.darValorUnitario() + "jabón: " + producto7.darValorUnitario()+ "bufanda: "+producto8.darValorUnitario();
    }
